...
public class InvestmentInStock {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int theInd=0;
        int numOfQuery=0;
        Integer[] indexs=new Integer[200000];
        Integer[] results=new Integer[200000];
        ...
        for (int i=0;i<zhixincishu;i++){
            ...
            for (int j=0;j<numOfInd;j++){
                if (theStack.isEmpty()){
                    ...
                    if (indexs[theStack.peek()]>=indexs[j]){
                        theStack.push(j);
                    }
                    else{
                        while(!theStack.isEmpty() && indexs[theStack.peek()]<indexs[j]){
                            theInd=theStack.pop();
                            results[theInd]=j-theInd;
                        }
                        theStack.push(j);
                    }
                }
            ...
            numOfQuery=in.nextInt();
            for (int j=0;j<numOfQuery;j++){
                theInd=in.nextInt();
                out.println(results[theInd-1]);
            }
