public class Weak_KMP {
    private static class MyKMP{
        public int M;
        public int[][] dfa;
        public String pat;
        public int c=256;
        ...
        public void initialDFA(){
            ...
            for (int i=1;i<M;i++){
                for (int j=0;j<c;j++){
                    dfa[j][i]=dfa[j][chongqi];
                }
                chongqi=dfa[pat.charAt(i)][chongqi];
        ...
        public MyList<Integer> search(String txt){
            ...
            for (int i=0,j=0;i<txt.length() && j<M;i++){
    ...
    public static void main(String[] args) {
        MyKMP aa=new MyKMP("bilan");
        MyList<Integer> answer=aa.search("qwniyaolaidianbilantubilanzima");
